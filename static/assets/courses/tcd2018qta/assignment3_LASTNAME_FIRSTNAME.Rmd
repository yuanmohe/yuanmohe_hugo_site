...
to first constructing the entire dfm, and then select features using a call to `dfm_lookup()`.
...
document.  Hint: Use `dfm_weight(youDfmName, "prop")` on the dfm.
...
Here, we will apply the dictionary of Laver, Michael, and John Garry. 2000. "Estimating Policy Positions From Political Texts." *American Journal of Political Science* 44(3): 619–34.  Using the pre-built Laver and Garry (2000) dictionary file,
...
*   download and save the Wordstat-formatted dictionary file
    [LaverGarry.cat](https://www.kenbenoit.net/courses/essex2014qta/LaverGarry.cat);
